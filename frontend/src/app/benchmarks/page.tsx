...
/** Display label for a project ref */
...
export default function BenchmarksPage() {
  ...
  // Saved internal repos (persisted in localStorage)
  ...
  // Selected internal repos (displayed as chips)
  ...
  // Load comparison when selection changes (with auto-backfill for missing external data)
  ...
  // Select internal repo from search (also persists to localStorage)
  ...
  // Remove internal repo from selection only (keep in saved list)
  const removeInternalRepo = (repoName: string) => {
    setSelectedProjects(prev => prev.filter(p => p !== `internal:${repoName}`));
  };

  // Permanently remove a saved internal repo from localStorage
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg p-6 text-white">
          <h1 className="text-2xl font-bold">Project Benchmarks</h1>
          <p className="mt-1 text-indigo-100">
            Compare productivity metrics across Tokamak repos and external open-source projects
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            {/* Saved repos list (checkbox like external projects) */}
            ...
            <div className="border-t pt-3">
              ...
              {addingProject && (
                <p className="mt-1.5 text-xs text-indigo-600 flex items-center gap-1">
                  <div className="animate-spin h-3 w-3 border-2 border-indigo-600 border-t-transparent rounded-full flex-shrink-0" />
