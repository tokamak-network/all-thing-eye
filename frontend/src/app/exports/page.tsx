...
export default function ExportsPage() {
  ...
  const handleBulkDownload = async () => {
    ...
    try {
      ...
      link.href = url;
      const dateRangeSuffix = startDate && endDate ? `_${startDate}_${endDate}` : '';
      link.download = `all_thing_eye_export${dateRangeSuffix}_${new Date().toISOString().split('T')[0]}.zip`;
      ...
      <div className="max-w-4xl mx-auto">
              ...
              return (
                <div key={source} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-3 mb-3 pb-3 border-b border-gray-200">
                    ...
                    >
                      📂 {source} <span className="text-sm text-gray-500 font-normal">({tableList.length} tables)</span>
                    </label>
                  </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• <strong>Select All Tables in Source:</strong> Click the checkbox next to a source name (e.g., "github") to select all tables under it</li>
            <li>• <strong>Select Individual Tables:</strong> Check the boxes next to specific tables you want to export</li>
            <li>• <strong>Date Range Filter:</strong> Use the date picker to filter exports by timestamp (applies to tables with timestamp columns)</li>
            <li>• <strong>Quick Presets:</strong> Click preset buttons (Last 7d, Last 30d, etc.) for common date ranges</li>
            <li>• <strong>Bulk Download:</strong> Select multiple tables and click "Download Selected as ZIP" to get all tables in one file</li>
            ...
            <li>• Date filtering only applies to tables with timestamp/posted_at/created_at columns</li>
          </ul>
        </div>
      </div>
    </div>
